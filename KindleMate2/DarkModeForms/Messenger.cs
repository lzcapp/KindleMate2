...
namespace KindleMate2.DarkModeForms {
    ...
    public static class Messenger {
        ...
        public static DialogResult MesageBox(string Message, string title, MessageBoxButtons buttons = MessageBoxButtons.OK, MessageBoxIcon icon = MessageBoxIcon.Information) {
            ...
            switch (icon) {
                case MessageBoxIcon.Information:
                    Icon = Base64Icons.MsgIcon.Info;
                    break;
                case MessageBoxIcon.Exclamation:
                    Icon = Base64Icons.MsgIcon.Success;
                    break;
                case MessageBoxIcon.Question:
                    Icon = Base64Icons.MsgIcon.Question;
                    break;
                case MessageBoxIcon.Error:
                    Icon = Base64Icons.MsgIcon.Cancel;
                    break;
                default:
                    break;
            }
        ...
        /// <param name="buttons">One of the MessageBoxButtons values that specifies which buttons to display in the message box.</param>
        /// <returns>It is a modal window, blocking other actions in the application until the user closes it.</returns>
        public static DialogResult MesageBox(string Message, string title, Base64Icons.MsgIcon Icon, MessageBoxButtons buttons = MessageBoxButtons.OK) {
            Form form = new Form {
        ...
        public static DialogResult InputBox(string title, string promptText, ref List<KeyValue> Fields, Base64Icons.MsgIcon Icon = 0, MessageBoxButtons buttons = MessageBoxButtons.OK) {
            Form form = new Form {
                FormBorderStyle = FormBorderStyle.FixedDialog,
                StartPosition = FormStartPosition.CenterParent,
                MaximizeBox = false,
