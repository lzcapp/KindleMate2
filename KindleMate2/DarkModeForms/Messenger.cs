...
namespace KindleMate2.DarkModeForms {
    ...
    public class KeyValue {
        ...
        /// <summary>
        ///     Permite Validar el Valor del Control:
    ...
    /// <summary>
    ///     Collection of Static Icons for General Purposes.
    ///     Default Image size is 64x64 px.
    /// </summary>
    public class Base64Icons {
        public List<Base64Image> Icons { get; set; } = new() {
            new("Info",
        ...
        public Image GetIcon(string pName) {
            ...
            if (Icons != null && Icons.Count > 0) {
                Base64Image? Found = Icons.Find(x => x.Name == pName);
                if (Found != null) {
                    _ret = Found.Image;
                }
            }
        ...
        public bool AddIcon(string pName, string pFilePath) {
            ...
            if (!string.IsNullOrEmpty(pFilePath) && File.Exists(pFilePath)) {
                ...
                if (_icon != null) {
                    if (Icons is null) {
                        Icons = new List<Base64Image>();
                    }
                    Icons.Add(new Base64Image(pName, Convert.ToBase64String(_icon)));
                    _ret = true;
                }
            }
            return _ret;
